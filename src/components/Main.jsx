        ...
        <>
            <main className='max-w-3xl m-auto w-full h-screen text-center flex justify-center items-center'>
                ...
                <div className='flex justify-center items-center flex-col gap-2'>
                    ...
                    Do you want to be my Valentine? </h1>
                    ...
                    <section className='flex gap-3'>
                        ...
                        <button className='bg-blue-500 w-28 text-white font-bold py-2 px-4 rounded duration-500 transition-all hover:scale-110' onClick={handleButtonYes}> Yes </button>
